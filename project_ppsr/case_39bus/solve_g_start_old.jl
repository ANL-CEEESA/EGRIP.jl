...
wind = Dict("activation"=>0, "violation_probability"=>0, "sample_number"=>0, "seed"=>0)


ref, model[1], pw_sp[1] = solve_startup(dir_case_network, network_data_format,
                                dir_case_blackstart, dir_case_result,
                                t_final, t_step, gap, formulation_type, wind)
