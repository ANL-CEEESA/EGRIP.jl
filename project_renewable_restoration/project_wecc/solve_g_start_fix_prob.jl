...
label_list = ["W/O Wind", "Wind: Mean 100, Var 50",
                            "Wind: Mean 200, Var 100",
                            "Wind: Mean 500, Var 250",
                            "Wind: Mean 1000, Var 500"]
...
wind[2] = Dict("activation"=>1, "sample_number"=>500, "violation_probability"=>0.1, "mean"=>1, "var"=>0.5) # power is in MVA base
wind[3] = Dict("activation"=>1, "sample_number"=>500, "violation_probability"=>0.1, "mean"=>2, "var"=>1)
wind[4] = Dict("activation"=>1, "sample_number"=>500, "violation_probability"=>0.1, "mean"=>5, "var"=>2.5)
wind[5] = Dict("activation"=>1, "sample_number"=>500, "violation_probability"=>0.1, "mean"=>10, "var"=>5)
...
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_wecc_fix_prob_gen.png")
...
# fig.tight_layout(pad=0.2, w_pad=0.2, h_pad=0.2)
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_wecc_fix_prob_load.png")
# PyPlot.savefig(sav_dict)
#
# PyPlot.pygui(true) # If true, return Python-based GUI; otherwise, return Julia backend
# rcParams = PyPlot.PyDict(PyPlot.matplotlib."rcParams")
...
# fig.tight_layout(pad=0.2, w_pad=0.2, h_pad=0.2)
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_wecc_fix_prob_cap.png")
# PyPlot.savefig(sav_dict)
#
# PyPlot.pygui(true) # If true, return Python-based GUI; otherwise, return Julia backend
# rcParams = PyPlot.PyDict(PyPlot.matplotlib."rcParams")
...
# fig.tight_layout(pad=0.2, w_pad=0.2, h_pad=0.2)
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_wecc_fix_prob_wind_dispatch.png")
# PyPlot.savefig(sav_dict)
#
#
# PyPlot.pygui(true) # If true, return Python-based GUI; otherwise, return Julia backend
...
# fig.tight_layout(pad=0.2, w_pad=0.2, h_pad=0.2)
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_wecc_fix_prob_wind_sample.png")
# PyPlot.savefig(sav_dict)
#
#
# # save data into json
...
# open("results_startup/data_gen_startup_wecc_fix_prob_wind.json","w") do f
#   JSON.print(f, json_string)
# end
# json_string = JSON.json(Pg_seq)
# open("results_startup/data_gen_startup_wecc_fix_prob_gen.json","w") do f
#   JSON.print(f, json_string)
# end
# json_string = JSON.json(Pd_seq)
# open("results_startup/data_gen_startup_wecc_fix_prob_load.json","w") do f
#   JSON.print(f, json_string)
# end
