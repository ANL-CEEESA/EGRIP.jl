...
label_list = ["W/O Wind",
              ...
              "Wind: Sample 500, Prob 0.20",
              "Wind: Sample 500, Prob 0.30",
              "Wind: Sample 500, Prob 0.40"]
...
wind_data = CSV.read("../../ERCOT_wind/wind_farm2_POE.csv", DataFrame)
...
wind = Dict()
pw_sp = Dict()
wind[1] = Dict("activation"=>0, "violation_probability"=>0.00, "sample_number"=>500, "seed"=>10050)
wind[2] = Dict("activation"=>0, "violation_probability"=>0.00, "sample_number"=>500, "seed"=>10050)
wind[3] = Dict("activation"=>3, "violation_probability"=>0.20, "sample_number"=>500, "seed"=>10050)
wind[4] = Dict("activation"=>3, "violation_probability"=>0.30, "sample_number"=>500, "seed"=>10050)
wind[5] = Dict("activation"=>3, "violation_probability"=>0.40, "sample_number"=>500, "seed"=>10050)
...
# fig.tight_layout(pad=0.2, w_pad=0.2, h_pad=0.2)
# PyPlot.show()
# sav_dict = string(pwd(), "/", dir_case_result, "fig_gen_startup_fix_sample_cap_wecc.png")
# PyPlot.savefig(sav_dict)
#
...
# #     ax.plot(t_step:t_step:t_final, wind_data[1:1:30, i], color="k", linewidth=0.5)
# # end
# # for i in test_from:test_end
# #     if i >= 2
